			...
			!(function (t) {
				...
				function (t, n, e) {
					...
					(t.exports = function (t, n, e, u) {
						...
						return (
							('function' == typeof this && f(this).source) || u(this)
						);
					});
				},
				function (t, n, e) {
						...
						{ target: 'Array', proto: !0, forced: !h || !v },
						{
							slice: function (t, n) {
								...
								if (
									...
									return d.call(l, h, v);
								for (
									r = new (void 0 === e ? Array : e)(y(v - h, 0)),
										s = 0;
									h < v;
									h++, s++
								)
						...
						getConstructor: function (t, n, e, f) {
							...
							return (
								i(s.prototype, {
									clear: function () {
										for (
											var t = h(this), n = t.index, e = t.first;
											e;
					...
					r(
						{ target: 'String', stat: !0, forced: !!a && 1 != a.length },
						{
							fromCodePoint: function (t) {
								for (
									var n, e = [], r = arguments.length, a = 0;
									r > a;
						...
						return [
							...
							function (t) {
								...
								for (var l, p = [], h = 0; null !== (l = c(a, f)); ) {
									...
									(p[h] = v),
										'' === v &&
											(a.lastIndex = u(f, i(a.lastIndex), s)),
										h++;
								}
								return 0 === h ? null : p;
							},
...
*/
						...
						var f = l.then(function (r) {
							return Promise.all(
								r[0].map(function (o, i) {
									var c = r[1][i];
									return Promise.resolve(n.resolve(o, t)).then(
										function (r) {
											var o = e(n, r, t);
		...
		function parseCss(e, t) {
			...
			if (((e.parsedCssText = e.cssText = r.trim()), e.parent)) {
				...
				)).replace(RX.multipleSpaces, ' ')).substring(
					r.lastIndexOf(';') + 1
				);
						  ...
						  new Promise(function (t) {
								e.win.requestAnimationFrame(function () {
									startWatcher(e.doc, e.globalScopes),
										loadDocument(e.doc, e.globalScopes).then(
											function () {
												return t();
											}
										);
		...
		var scriptElm =
			...
			Array.from(document.querySelectorAll('script')).find(function (s) {
				return (
					regex.test(s.src) ||
					s.getAttribute('data-stencil-namespace') === 'ionic'
				);
			});
